...
Started 2026-09-09; U6 Pro bought, UCG-Ultra to be ordered/installed. Full plan + DHCP reservation table + cutover steps live in the vault: `Documents/Dantec/DANOTTO/Projects/Factory Network & VPN Upgrade.md` (plain copy `Documents/Dantec/Factory-Network-Plan.md`).
