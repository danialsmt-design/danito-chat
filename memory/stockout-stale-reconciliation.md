...
metadata: 
  ...
  modified: 2026-08-17T08:18:27.428Z
---
...
**C-rank under-200 not-on-feeder pass (2026-08-17):** zeroed 13 C-rank reels (rank from PartRanks), latest row per UID, Qty 1–199, NOT loaded on any feeder (excluded via inventory.json) — 1,594 pcs, transaction-guarded (@@ROWCOUNT=13). Backup `MCS/zero-crank-under200-notfeeder_BACKUP.csv`. This was NOT previously done — the C<200 threshold is swap-triggered retire only, never a standing sweep (see [[pvs-spare-vs-loaded]], [[pvs-reel-retire-rank-rule]]).
