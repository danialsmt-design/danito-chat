...
- [Line-manning vision](line-manning-vision.md) — planned: per-line camera presence + badge identity fused in MCS brain → manned/unmanned/by-whom + "running unattended" alarm; spec in MCS/line-manning-spec.md.
